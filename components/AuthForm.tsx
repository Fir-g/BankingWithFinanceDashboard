                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        {type === 'sign-up' && (
                            <>
                                ...
                                <div className="flex gap-4">
                                        <CustomInput control={form.control}
                                            name='city' label='City' placeholder='ex: Varanasi' />
                                    <CustomInput control={form.control}
                                        name='state' label='State' placeholder='ex: Delhi' />
                                    <CustomInput control={form.control}
                                        name='country' label='Country' placeholder='ex:India' />
                                </div>
                                <div className='flex gap-4'>
                                    <CustomInput control={form.control}
                                        name='pinCode' label='Pin Code' placeholder='ex: 100XXX ' />
                                    <CustomInput control={form.control}
